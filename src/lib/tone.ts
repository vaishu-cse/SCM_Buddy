...
const TONES: Record<Tone, ToneClasses> = {
  red: {
    bg: "bg-tone-red-bg",
    border: "border-tone-red-border",
    fg: "text-tone-red-fg",
    icon: "text-tone-red-icon",
    fill: "bg-tone-red-icon",
  },
  amber: {
    bg: "bg-tone-amber-bg",
